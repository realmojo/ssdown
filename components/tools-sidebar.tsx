...
import {
  ...
  AlignLeft,
  // Utility
  QrCode, Calculator, Download, Eye,
  // File
...
const categoryConfig: Record<string, { tools: ToolItem[]; label: string; dictKey: string; activeColor: string; activeIconColor: string; activeBg: string }> = {
  ...
  utility: {
    ...
    tools: [
      { href: "/utility/youtube-thumbnail", icon: Download, key: "youtube_thumbnail" },
      { href: "/utility/youtube-preview", icon: Eye, key: "youtube_preview" },
