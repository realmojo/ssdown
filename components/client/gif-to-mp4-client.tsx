              ...
              >
                {loading ? (
                  <>
                    ...
                    {dict?.gif_to_mp4?.loading_engine ||
                ...
                {[
                  {
                    ...
                    desc:
                      dict?.gif_to_mp4?.step1_desc ||
                      "Drag and drop an animated GIF file or click to browse. Large GIFs work best with this tool since MP4 offers much better compression.",
                    icon: Upload,
                  },
                  {
                    step: 2,
                    ...
                    desc:
                      dict?.gif_to_mp4?.step2_desc ||
                      "Choose your preferred frame rate and quality level. Higher FPS means smoother playback, while lower CRF means better quality.",
                    icon: ImageIcon,
                  },
                  {
                    step: 3,
            ...
            <section className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-8 md:p-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  {
                    title:
                      dict?.gif_to_mp4?.tip1_title || "Massive Size Reduction",
                    desc:
                      dict?.gif_to_mp4?.tip1_desc ||
                      "MP4 files can be 80-90% smaller than the original GIF while maintaining the same visual quality thanks to H.264 compression.",
                    icon: FileVideo,
                  },
                  {
                    title: dict?.gif_to_mp4?.tip2_title || "100% Private",
                    desc:
                      dict?.gif_to_mp4?.tip2_desc ||
                      "Your GIF never leaves your device. All processing happens locally in your browser using WebAssembly technology.",
                    icon: CheckCircle2,
                  },
                  {
                    title:
                      dict?.gif_to_mp4?.tip3_title || "Match the Original FPS",
                    desc:
                      dict?.gif_to_mp4?.tip3_desc ||
                      "For the most accurate conversion, match the frame rate of the original GIF. Most GIFs use 10-15 FPS.",
                    icon: ImageIcon,
                  },
                  {
                    title:
                      dict?.gif_to_mp4?.tip4_title || "Browser Compatibility",
                    desc:
                      dict?.gif_to_mp4?.tip4_desc ||
                      "MP4 videos are universally supported across all modern browsers, social media platforms, and mobile devices.",
                    icon: Info,
                  },
                ].map((tip, idx) => (
                  <div
            ...
            <section>
              ...
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="item-2">
                  <AccordionTrigger className="text-left">
                    {dict?.gif_to_mp4?.faq_2_q ||
                      "Is my GIF uploaded to a server?"}
                  </AccordionTrigger>
                  <AccordionContent className="whitespace-pre-line text-muted-foreground">
                    {dict?.gif_to_mp4?.faq_2_a ||
