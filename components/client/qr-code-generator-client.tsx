          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="md:w-2/3 grid sm:grid-cols-2 gap-4">
              {[
                {
                  title:
                    dict?.qr_code_generator?.tip1_title || "Contrast is Key",
                ...
                {
                  title: dict?.qr_code_generator?.tip3_title || "Size Matters",
                  desc: dict?.qr_code_generator?.tip3_desc,
                },
                {
                  title: dict?.qr_code_generator?.tip4_title || "Test First",
