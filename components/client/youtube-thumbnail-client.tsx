              ...
              <Card className="mb-8 overflow-hidden bg-card/50 backdrop-blur-sm border-muted">
                <CardHeader>
                  ...
                  <CardDescription className="flex flex-wrap gap-x-4 gap-y-1 mt-2">
                    ...
                    <span>•</span>
                    <span>
                      {parseInt(result.viewCount).toLocaleString()} views
                    </span>
                  </CardDescription>
                </CardHeader>
              </Card>
          ...
          <div className="w-full max-w-6xl mx-auto mt-20 px-4 space-y-16">
            ...
            <section>
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl font-bold tracking-tight mb-4">
                  {dict?.youtube_thumbnail?.guide_title ||
                    "How to Download YouTube Thumbnails"}
                </h2>
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  {dict?.youtube_thumbnail?.guide_desc ||
                    "Follow these simple steps to download any YouTube video thumbnail in the highest quality available."}
                </p>
              </div>
                ...
                {[
                  {
                    step: 1,
                    title:
                      dict?.youtube_thumbnail?.step1_title ||
                      "Find the YouTube Video",
                    desc:
                      dict?.youtube_thumbnail?.step1_desc ||
                      "Open YouTube and navigate to the video whose thumbnail you want to download.",
                    icon: Search,
                  },
                  {
                    step: 2,
                    title:
                      dict?.youtube_thumbnail?.step2_title ||
                      "Copy the Video URL",
                    desc:
                      dict?.youtube_thumbnail?.step2_desc ||
                  ...
                  },
                  {
                    step: 3,
                    title:
                      dict?.youtube_thumbnail?.step3_title ||
                      "Download the Thumbnail",
                    desc:
                      dict?.youtube_thumbnail?.step3_desc ||
                      "Paste the URL, click Download, and choose your preferred resolution.",
                    icon: ImageDown,
                  },
                ].map((step) => (
                  <Card
            ...
            <section className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-8 md:p-12">
              <div className="text-center mb-10">
                ...
                <h2 className="text-3xl font-bold tracking-tight mb-4">
                  {dict?.youtube_thumbnail?.tips_title ||
                    "Tips for YouTube Thumbnails"}
                </h2>
                <p className="text-muted-foreground">
                  {dict?.youtube_thumbnail?.tips_desc ||
                    "Get the most out of YouTube thumbnail downloads with these helpful tips."}
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  {
                    title:
                      dict?.youtube_thumbnail?.tip1_title ||
                      "Choose the Highest Resolution",
                    desc:
                      dict?.youtube_thumbnail?.tip1_desc ||
                      "The 'Max Resolution' option provides the best quality, typically 1920x1080 or higher.",
                    icon: Maximize,
                  },
                  {
                    title:
                      dict?.youtube_thumbnail?.tip2_title ||
                      "Understanding Thumbnail Sizes",
                    desc:
                      dict?.youtube_thumbnail?.tip2_desc ||
                      "YouTube generates several thumbnail sizes: maxresdefault, sddefault, hqdefault, and mqdefault.",
                    icon: Image,
                  },
                  {
                    title:
                      dict?.youtube_thumbnail?.tip3_title ||
                      "Use for Content Research",
                    desc:
                      dict?.youtube_thumbnail?.tip3_desc ||
                      "Studying successful YouTube thumbnails is a proven strategy for improving your own click-through rates.",
                    icon: CheckCircle2,
                  },
                  {
                    title:
                      dict?.youtube_thumbnail?.tip4_title ||
                      "Respect Creator Rights",
                    desc:
                      dict?.youtube_thumbnail?.tip4_desc ||
                      "Thumbnails are created by video uploaders and are their intellectual property.",
                    icon: CheckCircle2,
                  },
                ].map((tip, idx) => (
                  <div
            ...
            <section>
              <div className="text-center mb-10">
                ...
                <h2 className="text-3xl font-bold tracking-tight mb-4">
                  {dict?.youtube_thumbnail?.features_title ||
                    "YouTube Thumbnail Download Features"}
                </h2>
                <p className="text-muted-foreground">
                  {dict?.youtube_thumbnail?.features_desc ||
                    "Everything you need to download and use YouTube thumbnails effectively."}
                </p>
              </div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  {
                    title:
                      dict?.youtube_thumbnail?.feature1_title ||
                      "All Available Sizes",
                    desc:
                      dict?.youtube_thumbnail?.feature1_desc ||
                      "Download every thumbnail resolution YouTube provides.",
                  },
                  {
                    title:
                      dict?.youtube_thumbnail?.feature2_title ||
                      "Instant Preview",
                    desc:
                      dict?.youtube_thumbnail?.feature2_desc ||
                      "See all thumbnail versions side by side with resolution details.",
                  },
                  {
                    title:
                      dict?.youtube_thumbnail?.feature3_title ||
                      "One-Click Download",
                    desc:
                      dict?.youtube_thumbnail?.feature3_desc ||
                      "Download any thumbnail size with a single click.",
                  },
                  {
                    title:
                      dict?.youtube_thumbnail?.feature4_title ||
                      "Video Information",
                    desc:
                      dict?.youtube_thumbnail?.feature4_desc ||
                      "View video title, channel name, and view count.",
                  },
                ].map((feature, idx) => (
            ...
            <section>
              <div className="text-center mb-10">
                <h2 className="text-3xl font-bold tracking-tight mb-4">
                  {dict?.qna_youtube_thumbnail?.title ||
                    "YouTube Thumbnail FAQ"}
                </h2>
                <p className="text-muted-foreground">
                  {dict?.qna_youtube_thumbnail?.desc ||
                    "Common questions about downloading YouTube video thumbnails."}
                </p>
              </div>
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                  <AccordionItem key={i} value={`item-${i}`}>
                    <AccordionTrigger className="text-left">
                      {dict?.qna_youtube_thumbnail?.[`faq_${i}_q`] ||
                        "Question"}
                    </AccordionTrigger>
