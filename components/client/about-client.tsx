      ...
      <section className="relative overflow-hidden py-20 lg:py-28 text-center bg-gray-50 dark:bg-gray-900/20">
        <div className="container px-4 md:px-6">
          ...
          <p className="mx-auto max-w-[800px] text-gray-600 md:text-xl dark:text-gray-300">
            {dict?.about?.subtitle ||
              "Your Ultimate Social Media Video Downloader"}
          </p>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6 space-y-20">
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                {dict?.about?.description ||
                  "SSDown is a comprehensive online tool designed to help you download videos from various social media platforms."}
              </p>
              <p className="text-muted-foreground text-lg leading-relaxed">
                {dict?.about?.mission_desc ||
                  "We believe that content should be accessible offline without restrictions."}
              </p>
            </div>
            <div className="relative h-[400px] rounded-2xl overflow-hidden bg-linear-to-br from-indigo-500 to-purple-600 shadow-2xl flex items-center justify-center p-8">
          ...
          <div>
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tight mb-4">
                {dict?.about?.features_title || "Why Use SSDown?"}
              </h2>
            </div>
          ...
          <div className="rounded-3xl bg-indigo-600 dark:bg-indigo-900 text-white p-12 text-center">
            <h2 className="text-2xl font-bold mb-4">
              {dict?.about?.contact_title || "Contact Us"}
            </h2>
            <p className="text-indigo-100 max-w-2xl mx-auto mb-8">
              {dict?.about?.contact_desc ||
