    ...
    <div className="w-full max-w-6xl mx-auto mt-3 px-4 space-y-3">
      ...
      <section className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-8 md:p-12">
        <div className="text-center mb-2">
          ...
          <h2 className="mb-1.5 border-b border-[var(--pt-line-strong)] pb-1 text-[14px] font-bold tracking-tight">콰이쇼우 다운로드 팁</h2>
      ...
      <section>
        <div className="text-center mb-2">
          ...
          <h2 className="mb-1.5 border-b border-[var(--pt-line-strong)] pb-1 text-[14px] font-bold tracking-tight">콰이쇼우 다운로드 기능</h2>
      ...
      <section>
        <div className="text-center mb-2">
          <h2 className="mb-1.5 border-b border-[var(--pt-line-strong)] pb-1 text-[14px] font-bold tracking-tight">콰이쇼우 자주 묻는 질문</h2>
          <p className="text-muted-foreground">
