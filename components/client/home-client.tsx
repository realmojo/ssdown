...
import { XIcon, TikTokIcon, InstagramIcon } from "@/components/ui/icons";
    ...
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
              ...
              <Card className="h-full border-2 border-transparent hover:border-black/5 dark:hover:border-white/10 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 bg-white dark:bg-gray-900/50 backdrop-blur-sm overflow-hidden relative">
                ...
                <CardContent className="p-8 flex flex-col items-center gap-4 relative z-10">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">{dict?.home?.card_x_desc || "Download videos & GIFs"}</p>
                  </div>
                  <div className="mt-auto pt-4 text-blue-600 dark:text-blue-400 font-medium flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0">
                    {dict?.home?.get_started || "Get Started"} <ArrowRight className="h-4 w-4" />
                  </div>
                </CardContent>
              </Card>
            </Link>
              ...
              <Card className="h-full border-2 border-transparent hover:border-black/5 dark:hover:border-white/10 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 bg-white dark:bg-gray-900/50 backdrop-blur-sm overflow-hidden relative">
                ...
                <CardContent className="p-8 flex flex-col items-center gap-4 relative z-10">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">{dict?.home?.card_tiktok_desc || "No watermark videos"}</p>
                  </div>
              ...
              <Card className="h-full border-2 border-transparent hover:border-black/5 dark:hover:border-white/10 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 bg-white dark:bg-gray-900/50 backdrop-blur-sm overflow-hidden relative">
                ...
                <CardContent className="p-8 flex flex-col items-center gap-4 relative z-10">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">{dict?.home?.card_insta_desc || "Reels, Stories & Photos"}</p>
                  </div>
      ...
      <section className="py-12 border-y bg-gray-50/50 dark:bg-gray-900/20">
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="space-y-2">
              <h4 className="text-4xl font-bold text-gray-900 dark:text-white">100%</h4>
              <p className="text-sm text-gray-500 uppercase tracking-wide font-medium">{dict?.home?.stat_free || "Free to Use"}</p>
            </div>
            <div className="space-y-2">
              <h4 className="text-4xl font-bold text-gray-900 dark:text-white">1M+</h4>
              <p className="text-sm text-gray-500 uppercase tracking-wide font-medium">{dict?.home?.stat_downloads || "Downloads"}</p>
            </div>
            <div className="space-y-2">
              <h4 className="text-4xl font-bold text-gray-900 dark:text-white">0s</h4>
              <p className="text-sm text-gray-500 uppercase tracking-wide font-medium">{dict?.home?.stat_wait || "Wait Time"}</p>
            </div>
            <div className="space-y-2">
              <h4 className="text-4xl font-bold text-gray-900 dark:text-white">4K</h4>
              <p className="text-sm text-gray-500 uppercase tracking-wide font-medium">{dict?.home?.stat_quality || "Supported Quality"}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white dark:bg-gray-950">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">{dict?.home?.why_title || "Why Choose SSDown?"}</h2>
            <p className="text-muted-foreground max-w-[600px] mx-auto text-lg">
              {dict?.home?.why_desc || "We provide the best tools to help you save and enjoy content offline."}
            </p>
          </div>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-start space-y-4 p-8 rounded-3xl bg-gray-50 dark:bg-gray-900/50 hover:bg-white hover:shadow-xl transition-all border border-transparent hover:border-gray-100 dark:hover:border-gray-800">
              ...
              <h3 className="text-xl font-bold">{dict?.common?.fast_downloads || "Lightning Fast"}</h3>
              <p className="text-muted-foreground leading-relaxed">
                {dict?.home?.feature_fast_desc || "Our optimized servers ensure you get your videos in seconds, not minutes. No queues, no waiting."}
              </p>
            </div>
            <div className="flex flex-col items-start space-y-4 p-8 rounded-3xl bg-gray-50 dark:bg-gray-900/50 hover:bg-white hover:shadow-xl transition-all border border-transparent hover:border-gray-100 dark:hover:border-gray-800">
              ...
              <h3 className="text-xl font-bold">{dict?.common?.high_quality || "Original Quality"}</h3>
              <p className="text-muted-foreground leading-relaxed">
                {dict?.home?.feature_quality_desc || "We don't compress your videos. Get the exact same quality as the source, up to 4K resolution."}
              </p>
            </div>
            <div className="flex flex-col items-start space-y-4 p-8 rounded-3xl bg-gray-50 dark:bg-gray-900/50 hover:bg-white hover:shadow-xl transition-all border border-transparent hover:border-gray-100 dark:hover:border-gray-800">
              ...
              <h3 className="text-xl font-bold">{dict?.common?.secure_private || "Secure & Private"}</h3>
              <p className="text-muted-foreground leading-relaxed">
                {dict?.home?.feature_secure_desc || "We respect your privacy. No logs are kept, and no personal information is required to use our service."}
              </p>
            </div>
            <div className="flex flex-col items-start space-y-4 p-8 rounded-3xl bg-gray-50 dark:bg-gray-900/50 hover:bg-white hover:shadow-xl transition-all border border-transparent hover:border-gray-100 dark:hover:border-gray-800">
              ...
              <h3 className="text-xl font-bold">{dict?.common?.mobile_friendly || "Mobile Friendly"}</h3>
              <p className="text-muted-foreground leading-relaxed">
                {dict?.home?.feature_mobile_desc || "Works perfectly on iPhone, Android, tablets, and desktop. No app installation needed."}
              </p>
            </div>
            <div className="flex flex-col items-start space-y-4 p-8 rounded-3xl bg-gray-50 dark:bg-gray-900/50 hover:bg-white hover:shadow-xl transition-all border border-transparent hover:border-gray-100 dark:hover:border-gray-800">
              ...
              <h3 className="text-xl font-bold">{dict?.common?.unlimited_downloads || "Unlimited Downloads"}</h3>
              <p className="text-muted-foreground leading-relaxed">
                {dict?.home?.feature_unlimited_desc || "No daily limits or restrictions. Download as many videos as you want, completely free forever."}
              </p>
            </div>
            <div className="flex flex-col items-start space-y-4 p-8 rounded-3xl bg-gray-50 dark:bg-gray-900/50 hover:bg-white hover:shadow-xl transition-all border border-transparent hover:border-gray-100 dark:hover:border-gray-800">
              ...
              <h3 className="text-xl font-bold">{dict?.common?.easy_sharing || "Easy Sharing"}</h3>
              <p className="text-muted-foreground leading-relaxed">
                {dict?.home?.feature_sharing_desc || "Download and share directly to WhatsApp, Telegram, or any other platform with a single click."}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container px-4 md:px-6 text-center text-white space-y-8">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">{dict?.home?.cta_title || "Ready to Start Downloading?"}</h2>
          <p className="text-indigo-100 max-w-[600px] mx-auto text-xl">
             {dict?.home?.cta_desc || "Join millions of users who trust SSDown for their video downloading needs."}
          </p>
          <div className="flex flex-wrap justify-center gap-4">
             <Link href={getPath("/x")}>
                <Button size="lg" className="h-14 px-8 text-lg bg-white text-indigo-600 hover:bg-gray-100 hover:text-indigo-700 font-bold border-0">
                    {dict?.home?.cta_btn_x || "Try for X (Twitter)"}
                </Button>
             </Link>
             <Link href={getPath("/tiktok")}>
                <Button size="lg" className="h-14 px-8 text-lg bg-transparent border-2 border-white text-white hover:bg-white/10 font-bold">
