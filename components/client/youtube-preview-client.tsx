...
export function YoutubePreviewClient({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.id) {
        router.push(`/utility/youtube-preview/${data.id}`);
      }
    } catch (err: any) {
      console.error(err);
      setError(
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="text-xs text-muted-foreground">
                            ...
                            <p className="mb-2">
                              ...
                              Privacy Protection Act (COPPA) and/or other laws.
                              You're required to tell us whether your videos are
                              made for kids.
                            </p>
                      ...
                      {showMore && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-top-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                              If you accepted anything of value to make this
                              video, you must avoid creating a false impression.
                            </p>
                            <div className="flex items-start space-x-2">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                              ...
                              commonly misspelled. Otherwise, tags play a
                              minimal role in your video's discovery.
                            </p>
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                              Add your video to a category so viewers can find
                              it more easily.
                            </p>
                            <Select
                              value={category}
          ...
          <div className="w-full max-w-6xl mx-auto mt-20 px-4 space-y-16">
            ...
            <section>
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl font-bold tracking-tight mb-4">
                  {dict?.youtube_preview?.guide_title ||
                    "How to Use YouTube Preview Editor"}
                </h2>
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  {dict?.youtube_preview?.guide_desc ||
                    "Learn how to preview and optimize your YouTube video metadata for better visibility."}
                </p>
              </div>
                ...
                {[
                  {
                    step: 1,
                    title:
                      dict?.youtube_preview?.step1_title ||
                      "Enter the Video URL",
                    desc:
                      dict?.youtube_preview?.step1_desc ||
                      "Paste any YouTube video URL to load its current metadata.",
                    icon: Link2,
                  },
                  {
                    step: 2,
                    title:
                      dict?.youtube_preview?.step2_title || "Edit the Metadata",
                    desc:
                      dict?.youtube_preview?.step2_desc ||
                      "Modify the video title, description, tags, and other settings.",
                    icon: PenLine,
                  },
                  {
                    step: 3,
                    title:
                      dict?.youtube_preview?.step3_title ||
                      "Preview the Result",
                    desc:
                      dict?.youtube_preview?.step3_desc ||
                      "Review how your video will appear on YouTube with the updated metadata.",
                    icon: Eye,
                  },
                ].map((step) => (
                  <Card
            ...
            <section className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-8 md:p-12">
              <div className="text-center mb-10">
                ...
                <h2 className="text-3xl font-bold tracking-tight mb-4">
                  {dict?.youtube_preview?.tips_title ||
                    "YouTube Metadata Optimization Tips"}
                </h2>
                <p className="text-muted-foreground">
                  {dict?.youtube_preview?.tips_desc ||
                    "Improve your video's visibility and click-through rate with these proven strategies."}
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  {
                    title:
                      dict?.youtube_preview?.tip1_title ||
                      "Craft Compelling Titles",
                    desc:
                      dict?.youtube_preview?.tip1_desc ||
                      "Keep titles under 60 characters. Place important keywords at the beginning.",
                    icon: Type,
                  },
                  {
                    title:
                      dict?.youtube_preview?.tip2_title ||
                      "Write Detailed Descriptions",
                    desc:
                      dict?.youtube_preview?.tip2_desc ||
                      "Include a summary in the first 2-3 lines, relevant keywords, timestamps, and links.",
                    icon: FileText,
                  },
                  {
                    title:
                      dict?.youtube_preview?.tip3_title || "Use Strategic Tags",
                    desc:
                      dict?.youtube_preview?.tip3_desc ||
                      "Add 5-15 relevant tags mixing broad and specific terms.",
                    icon: Tags,
                  },
                  {
                    title:
                      dict?.youtube_preview?.tip4_title ||
                      "Optimize Thumbnail Selection",
                    desc:
                      dict?.youtube_preview?.tip4_desc ||
                      "Choose thumbnails with bright colors, clear text overlay, and expressive faces.",
                    icon: CheckCircle2,
                  },
                ].map((tip, idx) => (
                  <div
            ...
            <section>
              <div className="text-center mb-10">
                ...
                <h2 className="text-3xl font-bold tracking-tight mb-4">
                  {dict?.youtube_preview?.features_title ||
                    "Preview Editor Features"}
                </h2>
                <p className="text-muted-foreground">
                  {dict?.youtube_preview?.features_desc ||
                    "Everything you need to perfect your YouTube video metadata."}
                </p>
              </div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  {
                    title:
                      dict?.youtube_preview?.feature1_title ||
                      "YouTube Studio Interface",
                    desc:
                      dict?.youtube_preview?.feature1_desc ||
                      "Edit metadata in an interface that mirrors YouTube Studio.",
                  },
                  {
                    title:
                      dict?.youtube_preview?.feature2_title ||
                      "Real-Time Preview",
                    desc:
                      dict?.youtube_preview?.feature2_desc ||
                      "See your changes reflected instantly in the preview panel.",
                  },
                  {
                    title:
                      dict?.youtube_preview?.feature3_title || "Tag Management",
                    desc:
                      dict?.youtube_preview?.feature3_desc ||
                      "Add, remove, and organize video tags with an intuitive editor.",
                  },
                  {
                    title:
                      dict?.youtube_preview?.feature4_title ||
                      "Complete Settings",
                    desc:
                      dict?.youtube_preview?.feature4_desc ||
                      "Preview audience settings, license options, and more.",
                  },
                ].map((feature, idx) => (
            ...
            <section>
              <div className="text-center mb-10">
                <h2 className="text-3xl font-bold tracking-tight mb-4">
                  {dict?.qna_youtube_preview?.title ||
                    "YouTube Preview Editor FAQ"}
                </h2>
                <p className="text-muted-foreground">
                  {dict?.qna_youtube_preview?.desc ||
                    "Frequently asked questions about using the YouTube Preview Editor."}
                </p>
              </div>
