...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = "Convert PDF pages to PNG images instantly. Lossless quality with transparency support. 100% private — processed in your browser, no upload to server.";
...
export default function PdfToPngPage() {
  const faqSchema = {
    ...
    mainEntity: [
      { "@type": "Question", name: "Is it free to convert PDF to PNG?", acceptedAnswer: { "@type": "Answer", text: "Yes, this tool is 100% free with no hidden fees or watermarks." } },
      { "@type": "Question", name: "Why choose PNG over JPG?", acceptedAnswer: { "@type": "Answer", text: "PNG offers lossless compression, meaning no quality loss. It also supports transparency, making it ideal for documents with transparent backgrounds." } },
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "PDF to PNG", item: "https://ssdown.app/pdf/pdf-to-png" },
    ],
  };
