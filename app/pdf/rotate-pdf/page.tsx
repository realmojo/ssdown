...
export default async function RotatePdfPage() {
  ...
  const webAppSchema = {
    ...
    "@type": "WebApplication",
    name: "Rotate Pdf",
    url: "https://ssdown.app/pdf/rotate-pdf",
    applicationCategory: "UtilityApplication",
    operatingSystem: "Web Browser",
    browserRequirements: "Requires JavaScript. Works in all modern browsers.",
    offers: { "@type": "Offer", price: "0", priceCurrency: "USD" },
    description: "Free online rotate pdf tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Rotate Pdf Online",
    description: "Use our free online rotate pdf tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
