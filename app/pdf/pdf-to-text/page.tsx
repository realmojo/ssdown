...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = "Extract all text from PDF files instantly. Copy to clipboard or download as TXT file. 100% private — processed in your browser, no upload to server.";
...
export default function PdfToTextPage() {
  const faqSchema = {
    ...
    mainEntity: [
      { "@type": "Question", name: "Is it free to extract text from PDF?", acceptedAnswer: { "@type": "Answer", text: "Yes, this tool is 100% free with no hidden fees or usage limits." } },
      { "@type": "Question", name: "Can it extract text from scanned PDFs?", acceptedAnswer: { "@type": "Answer", text: "This tool extracts embedded text from PDFs. Scanned documents (image-based PDFs) may not contain extractable text and would require OCR." } },
      { "@type": "Question", name: "Can I copy the extracted text?", acceptedAnswer: { "@type": "Answer", text: "Yes, you can copy all extracted text to your clipboard with one click or download it as a .txt file." } },
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "PDF to Text", item: "https://ssdown.app/pdf/pdf-to-text" },
    ],
  };
