...
export default async function PdfEditorPage() {
  ...
  const webAppSchema = {
    ...
    description: "Free online pdf editor tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Pdf Editor Online",
    description: "Use our free online pdf editor tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
