...
export default async function DeletePdfPagesPage() {
  ...
  const webAppSchema = {
    ...
    url: "https://ssdown.app/pdf/delete-pdf-pages",
    applicationCategory: "UtilityApplication",
    operatingSystem: "Web Browser",
    browserRequirements: "Requires JavaScript. Works in all modern browsers.",
    offers: { "@type": "Offer", price: "0", priceCurrency: "USD" },
    description: "Free online delete pdf pages tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Delete Pdf Pages Online",
    description: "Use our free online delete pdf pages tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
