...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = "Add text to your PDF files instantly. Choose page, position, font size, and color. 100% private — processed in your browser, no upload to server.";
...
export default function AddTextToPdfPage() {
  const faqSchema = {
    ...
    mainEntity: [
      { "@type": "Question", name: "Is it free to add text to a PDF?", acceptedAnswer: { "@type": "Answer", text: "Yes, this tool is 100% free with no hidden fees or watermarks." } },
      { "@type": "Question", name: "Can I add text to a specific page?", acceptedAnswer: { "@type": "Answer", text: "Yes, you can select which page to add text to using the page selector dropdown." } },
      { "@type": "Question", name: "What fonts are available?", acceptedAnswer: { "@type": "Answer", text: "We use Helvetica, a standard PDF font. This ensures compatibility across all PDF viewers." } },
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Add Text to PDF", item: "https://ssdown.app/pdf/add-text-to-pdf" },
    ],
  };
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-6">
        <Breadcrumbs items={[
          ...
          { label: "Add Text to PDF", href: "/pdf/add-text-to-pdf", isCurrent: true },
        ]} />
      </div>
      <AddTextToPdfClient />
    </>
