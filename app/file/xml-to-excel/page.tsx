...
export default async function XmlToExcelPage() {
  ...
  const webAppSchema = {
    ...
    description: "Free online xml to excel tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Xml To Excel Online",
    description: "Use our free online xml to excel tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
