...
export default async function SplitExcelPage() {
  ...
  const webAppSchema = {
    ...
    description: "Free online split excel tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Split Excel Online",
    description: "Use our free online split excel tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
