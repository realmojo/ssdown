...
export default async function CsvToExcelPage() {
  ...
  const webAppSchema = {
    ...
    description: "Free online csv to excel tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Csv To Excel Online",
    description: "Use our free online csv to excel tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
