...
export default async function JsonToXmlPage() {
  ...
  const webAppSchema = {
    ...
    description: "Free online json to xml tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Json To Xml Online",
    description: "Use our free online json to xml tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
