...
export default async function CsvToJsonPage() {
  ...
  const webAppSchema = {
    ...
    description: "Free online csv to json tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Csv To Json Online",
    description: "Use our free online csv to json tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
