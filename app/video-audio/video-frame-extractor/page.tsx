...
export default async function VideoFrameExtractorPage() {
  ...
  const webAppSchema = {
    ...
    url: "https://ssdown.app/video-audio/video-frame-extractor",
    applicationCategory: "UtilityApplication",
    operatingSystem: "Web Browser",
    browserRequirements: "Requires JavaScript. Works in all modern browsers.",
    offers: { "@type": "Offer", price: "0", priceCurrency: "USD" },
    description: "Free online video frame extractor tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Video Frame Extractor Online",
    description: "Use our free online video frame extractor tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
