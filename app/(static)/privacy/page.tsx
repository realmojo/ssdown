    ...
    <div className="container py-12 md:py-24 max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
          ...
          <div className="p-6 pt-0 text-muted-foreground space-y-4">
            <p>
              ...
              address, or phone number. You can use our service completely
              anonymously.
            </p>
            <p>
              <strong>Usage Data (Log Files):</strong> Standard server logs are
              used for technical debugging and traffic analysis. This includes
              your IP address, browser type, referring pages, and timestamp.
              These logs are strictly for administrative use and are never
              linked to any personal profile.
            </p>
            <p>
        ...
        <div className="rounded-lg border bg-card text-card-foreground shadow-sm bg-yellow-50/50 dark:bg-yellow-900/10 border-yellow-200 dark:border-yellow-800">
          ...
          <div className="p-6 pt-0 text-muted-foreground space-y-4">
            <p>
              This site uses <strong>Google AdSense</strong> to serve ads.
              Google, as a third-party vendor, uses cookies to serve ads on our
              site.
            </p>
            <ul className="list-disc list-inside ml-2 space-y-2">
              <li>
                <strong>DoubleClick DART Cookie:</strong> Google&apos;s use of
                the DART cookie enables it to serve ads to our users based on
                their visit to our site and other sites on the Internet.
              </li>
              <li>
                <strong>Opt-Out:</strong> Users may opt-out of the use of the
            ...
            <p className="text-sm mt-2">
              ...
              by third-party advertisers. You should consult the respective
        ...
        <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
          ...
          <div className="p-6 pt-0 text-muted-foreground space-y-4">
            <p>
              We use standard cookies to improve user experience (e.g.,
              remembering your theme preference - Dark/Light mode). These
              cookies are entirely safe and do not contain sensitive personal
              data.
            </p>
            <p>
              ...
              visited from France?"). This data is anonymized and IP addresses
              are often masked before storage.
            </p>
          </div>
        </div>
