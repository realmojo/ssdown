...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const canonical = `${baseUrl}/tools/video-to-mp3`;
...
export default async function VideoToMp3Page() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Video to MP3 Converter", item: "https://ssdown.app/tools/video-to-mp3" },
    ],
  };
      ...
      <div className="container max-w-7xl mx-auto px-4 pt-8">
        <Breadcrumbs
          items={[
            ...
            { label: "Video to MP3", href: "/tools/video-to-mp3", isCurrent: true },
          ]}
        />
      </div>
