...
const CANONICAL = "https://ssdown.app/tools/file";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: buildAlternates("/tools/file"),
  };
}

export default async function Page() {
  const dict = await getDictionary();
  const section = dict.page_tools_file;
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: dict.breadcrumb.file_data_tools, item: CANONICAL },
    ],
  };
