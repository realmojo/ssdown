...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const canonical = `${baseUrl}/tools/hashtag-generator`;
...
export default async function HashtagGeneratorPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Hashtag Generator", item: "https://ssdown.app/tools/hashtag-generator" },
    ],
  };
      ...
      <div className="container max-w-7xl mx-auto px-4 pt-8">
        <Breadcrumbs
          items={[
            ...
            { label: "Hashtag Generator", href: "/tools/hashtag-generator", isCurrent: true },
          ]}
        />
      </div>
