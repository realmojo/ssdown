...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const canonical = `${baseUrl}/tools/thumbnail-generator`;
...
export default async function ThumbnailGeneratorPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Thumbnail Generator", item: "https://ssdown.app/tools/thumbnail-generator" },
    ],
  };
      ...
      <div className="container max-w-7xl mx-auto px-4 pt-8">
        <Breadcrumbs
          items={[
            ...
            { label: "Thumbnail Generator", href: "/tools/thumbnail-generator", isCurrent: true },
          ]}
        />
      </div>
