...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const canonical = `${baseUrl}/tools/watermark-remover`;
...
export default async function WatermarkRemoverPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Watermark Remover", item: "https://ssdown.app/tools/watermark-remover" },
    ],
  };
      ...
      <div className="container max-w-7xl mx-auto px-4 pt-8">
        <Breadcrumbs
          items={[
            ...
            { label: "Watermark Remover", href: "/tools/watermark-remover", isCurrent: true },
          ]}
        />
      </div>
