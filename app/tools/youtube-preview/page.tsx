...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const canonical = `${baseUrl}/tools/youtube-preview`;
...
export default async function YoutubePreviewPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "YouTube Preview Editor", item: "https://ssdown.app/tools/youtube-preview" },
    ],
  };
      ...
      <div className="container max-w-7xl mx-auto px-4 pt-8">
        <Breadcrumbs
          items={[
            ...
            { label: "YouTube Preview", href: "/tools/youtube-preview", isCurrent: true },
          ]}
        />
      </div>
