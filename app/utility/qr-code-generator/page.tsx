...
export default async function QRCodeGeneratorPage() {
  ...
  const webAppSchema = {
    ...
    url: "https://ssdown.app/utility/qr-code-generator",
    applicationCategory: "UtilityApplication",
    operatingSystem: "Web Browser",
    browserRequirements: "Requires JavaScript. Works in all modern browsers.",
    offers: { "@type": "Offer", price: "0", priceCurrency: "USD" },
    description: "Free online qr code generator tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Qr Code Generator Online",
    description: "Use our free online qr code generator tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
