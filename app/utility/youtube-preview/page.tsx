...
export default async function YoutubePreviewPage() {
  ...
  const webAppSchema = {
    ...
    url: "https://ssdown.app/utility/youtube-preview",
    applicationCategory: "UtilityApplication",
    operatingSystem: "Web Browser",
    browserRequirements: "Requires JavaScript. Works in all modern browsers.",
    offers: { "@type": "Offer", price: "0", priceCurrency: "USD" },
    description: "Free online youtube preview tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Youtube Preview Online",
    description: "Use our free online youtube preview tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
