...
export default async function AspectRatioCalculatorPage() {
  ...
  const webAppSchema = {
    ...
    description: "Free online aspect ratio calculator tool. Fast, secure, and browser-based.",
  };

  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to use Aspect Ratio Calculator Online",
    description: "Use our free online aspect ratio calculator tool to process your files securely in your browser.",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
